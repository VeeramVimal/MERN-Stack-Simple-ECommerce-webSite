...
const Test = () => {
  ...
  const getUserById = () => {
    axios.get(`http://localhost:8000/User/editUser/${id}`)
  ...
  const handleSubmit = (event) => {
    ...
    const {
      Name, Email, Password, DOB, MobileNumber, Gender, Above_Eighteen, Purpose
    } = State;


    axios.post(`http://localhost:8000/User/updateUser/${id}`, {
      Name: Name,
      Email: Email,
      Password: Password,
      DOB: selectedDate,
        ...
        <form onSubmit={handleSubmit}>
          ...
          <label>
            ...
            <select value={State.Gender} onChange={handleInChange}>
              <option value="None" name="Gender">None</option>
          ...
          <div className="radio-btn-container">
            <div className="radio-btn">
              ...
              <input type="radio" value="Bussiness" id="Bussiness"
                onChange={handleBtnChange} name="Purpose" />
              <label for="Bussiness">Bussiness</label>
            </div>

            <div className="radio-btn">
              <input type="radio" value="Individual" id="Individual"
                onChange={handleBtnChange} name="Purpose" />
